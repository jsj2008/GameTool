...
namespace XBOX
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            XBOXLogManager.Instance.LogEvent += LogManager_LogEvent;
            MainFrom = this;
        }
        ...
        private void LoadUcNet()
        {
            ...
            ucAdsl = new UcAdsl(adsl, XBOXLogManager.Instance);
            ...
            ucRouter = new UcRouter(router, XBOXLogManager.Instance);
            ...
            ucVpnList = new UcVpnList(vpn, XBOXLogManager.Instance);
            ...
            //ucVpn = new UcVpnItem(vpnItem, XBOXLogManager.Instance);
        ...
        public UCXBoxLogin ucLogin = null;
        private void AddUC(DetectionParamsItem detectionItem)
        {
            DisposeUC();
            if (null == ucLogin)
            {
                ucLogin = new UCXBoxLogin(detectionItem, XBOXLogManager.Instance) { Dock = DockStyle.Fill };
        ...
        private void btnFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择一个帐户数据文件", "（XBOX）提醒");
            }
        }
        ...
        private void httpManager_ProcessItemChanged(object sender, ProcessEventArgs<AccountItem> e)
        {
            lock (this)
            {
                ...
                {
                    XBOXLogManager.Instance.Info("Update UI error:" + ex.Message);
                }
            }
        }
            ...
            this.BeginInvoke(new ThreadStart(delegate()
             {
                 ...
                 MessageBox.Show(string.Format("完成（XBOX）网络对号 ！"));
                 SoundPlayer.StopWarn();
             }));
        }
