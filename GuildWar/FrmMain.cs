...
namespace GuildWar
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            FightLogManager.Instance.LogEvent += LogManager_LogEvent;
            MainFrom = this;
        }
        ...
        private void LoadUcNet()
        {
            ...
            ucAdsl = new UcAdsl(adsl, FightLogManager.Instance);
            ...
            ucRouter = new UcRouter(router, FightLogManager.Instance);
            ...
            ucVpnList = new UcVpnList(vpn, FightLogManager.Instance);
            ...
            //ucVpn = new UcVpnItem(vpnItem, FightLogManager.Instance);
        ...
        private void btnFile_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择一个帐户数据文件", "（GuildWar）提醒");
            }
        }
        ...
        private void httpManager_ProcessItemChanged(object sender, ProcessEventArgs<FightAccountItem> e)
        {
            lock (this)
            {
                if (this.isClosing) { return; }
                ...
                {
                    FightLogManager.Instance.Info("Update UI error:" + ex.Message);
                }
            }
        }
            ...
            this.BeginInvoke(new ThreadStart(delegate()
             {
                 ...
                 MessageBox.Show(string.Format("完成（GuildWar）网络对号 ！"));
                 SoundPlayer.StopWarn();
             }));
        }
